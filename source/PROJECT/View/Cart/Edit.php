...
<h2 class = "shortcode-heading-wrapper container"><span><a href="#">Sửa giỏ hàng</a></span></h2>
<p>
	<form method="post" action="index.php?mod=cart&act=edit&id=<?php echo $id; ?>" class="form" onSubmit="return IsEditCart()">
    	<p><label>Sản phẩm</label><input type="text" name="txtProduct" id="txtProduct" value="<?php echo $productName; ?>" readonly="readonly" disabled/></p>
